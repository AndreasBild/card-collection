...
echo "🤖 [Jules Environment Setup] Initializing environment for card-collection..."
echo "🔒 [Java 26 / Kotlin Invariant] Target runtime: Java 26 & Kotlin 2.x (Do NOT downgrade pom.xml)"
...
./mvnw -version 2>&1 || echo "Maven wrapper not executable or not found"
